...
def load_pdf(file_path: str, chunck_size: int = 4096) -> tuple[str, list[str] | str, dict]:
    ...
    if chunck_size > 0:
        splitter = RecursiveCharacterTextSplitter(chunk_size=chunck_size, chunk_overlap=chunck_size//10)
